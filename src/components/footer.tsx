  ...
  return (
    <footer className="bg-brand-primary">
      ...
      >
        ...
        <div className="mt-16 flex justify-center gap-x-10">
          {navigation.social.map((item) => (
            <a
              key={item.name}
              href={item.href}
              className="text-brand-text/60 hover:text-brand-secondary transition-colors duration-200"
            >
        ...
        <p className="mt-10 text-center text-sm/6 text-brand-text/60">
          © 2024 StoneBridge Realty LLC. All rights reserved.
        </p>
      </motion.div>
    </footer>
  );
